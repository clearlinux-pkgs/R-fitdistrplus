...
Version  : 1.0.11
Release  : 12
URL      : https://cran.r-project.org/src/contrib/fitdistrplus_1.0-11.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fitdistrplus_1.0-11.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536856583
